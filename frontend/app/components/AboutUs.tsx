      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <h3 className="text-3xl font-bold mb-4 text-white">We are Creative Storytellers</h3>
            <p className="text-gray-300 mb-6">
              At MyKidStory.ai, we blend engaging narratives with artistic vision to create digital experiences that
              captivate and inspire young minds. Our team of passionate designers, writers, and educators work
              tirelessly to push the boundaries of what's possible in children's storytelling.
            </p>
